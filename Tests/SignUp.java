...
public class SignUp {
  ...
  public void testSignUp() throws Exception {
    ...
    driver.findElement(By.id("signupEmail")).sendKeys("andresmith@unomaha.edu");
    driver.findElement(By.id("password")).clear();
    driver.findElement(By.id("password")).sendKeys("andre12345");
    driver.findElement(By.id("confirm-password")).clear();
    driver.findElement(By.id("confirm-password")).sendKeys("andre12345");
