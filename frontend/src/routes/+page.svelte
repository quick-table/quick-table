		...
		<form class="mb-2 mt-5">
			...
			<div class="flex items-center">
				...
				<a
					...
					class="block py-2 px-2 rounded-full dark:bg-surface-500 focus:outline-none focus:ring focus:border-blue-300"
				>
		...
		<form class="mt-2">
			...
			<div class="flex flex-col items-center">
				<div class="flex gap-3 flex-col md:flex-row">
					<input type="date" class="input w-40 py-2 px-4 rounded-full border" />

					<input type="time" class="input w-40 py-2 px-4 rounded-full border" />
